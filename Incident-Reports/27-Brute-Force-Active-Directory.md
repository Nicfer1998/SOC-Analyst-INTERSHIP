...
El 22 de mayo de 2026, el portal ITSM generó un incidente al detectar una alerta de Microsoft Sentinel clasificada como **Brute Force Attack on Active Directory**. La regla detecta 10 o más intentos de autenticación fallidos en una ventana de 10 minutos, excluyendo intentos hacia dominios inexistentes. Tras la investigación inicial, se identificó que una cuenta de dominio recibió 42 intentos fallidos desde una IP interna en menos de 4 minutos, resultando en el bloqueo de la cuenta. El incidente fue escalado al encargado de IT al finalizar el turno y queda pendiente de resolución.
...
| **Cuenta afectada** | [domain]\[username] |
...
> Una aplicación o servicio configurado con las credenciales de la cuenta objetivo intenta autenticarse repetidamente porque la contraseña expiró o fue cambiada. Es el escenario más común y benigno.

**Hipótesis B — Movimiento lateral:**
> Un atacante con acceso al workstation origen está intentando comprometer la cuenta objetivo mediante fuerza bruta interna.

### 4. Estado al cierre del turno

El incidente fue escalado al encargado de IT con toda la evidencia recopilada. Pendiente de:
- Identificar qué aplicación o proceso en el workstation origen genera los intentos
- Desbloquear la cuenta afectada una vez identificada la causa raíz
...
| Identificación de causa raíz | 🔄 Pendiente | IT debe identificar el proceso en el workstation origen. |
| Desbloqueo de la cuenta afectada | 🔄 Pendiente | Una vez confirmada la causa raíz. |
